...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/01-create-proyect.gif" alt="Create a Zeplin Proyect" width="1103" height="688" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/02-installing-zeplin-plugin.jpg" alt="Installing the Sketch plugin" width="500" height="260" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/03-design.jpg" alt="I made a small design in Sketch" width="720" height="512" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/04-create-colors.jpg" alt="Create colors" width="478" height="854" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/06-create-symbols.gif" alt="Create Symbols" width="837" height="512" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/012-text-styles-css.png" alt="CSS for the Styles" width="831" height="579" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/013-spacing-layout.png" alt="Spacing and Layout" width="831" height="462" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/014-relative-units.png" alt="Using relative measures (rems)" width="831" height="462" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/016-create-sections.jpg" alt="Create components sections" width="831" height="462" />

You can also organize it by groups, select multiple components in a section `Right Click> New Group from Selection`

<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/017-create-groups.jpg" alt="Create components groups" width="831" height="462" />
...
<Image src="/images/how-i-handoff-designs-to-developers-with-sketch-y-zeplin/019-sharing.png" alt="Zeplin sharing window" width="831" height="462" />
